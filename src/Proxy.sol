...
contract GNATI_BRIDGE is ERC20 {
    ...
    uint256 private constant cap = 3_300_000_000_000000000000000000; // 3.3B in 18 decimals
    uint256 private constant multiplier = 10000; // 10k

    using SafeERC20 for GNATI_BRIDGE;

    uint256 constant SATS_TO_WEI_STD = 10000000000;
    ...
    uint64 public constant verusvETHTransactionFee = 300000; //0.003 vETH 8 decimals

    constructor(string memory _name, string memory _symbol, address payable _linkedERC20, address iaddress)
        ERC20(_name, _symbol)
    {
    ...
    // @audit-issue Only the Verus Ethereum Bridge should call this
    ...
    function buildReserveTransfer(
        ...
        address sendTo,
        uint8 addressType,
        address destinationCurrency, // bridgeiAddress
        address feecurrencyid // vETHiAddress
    ) private view returns (Objects.CReserveTransfer memory) {
